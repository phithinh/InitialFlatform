...
#define CDCMSC_SIZ_CONFIG_DESC                  90       
...
extern const uint8_t CompositeVCPMass_DeviceDescriptor[VIRTUAL_COM_PORT_SIZ_DEVICE_DESC];

extern const uint8_t Virtual_Com_Port_ConfigDescriptor[VIRTUAL_COM_PORT_SIZ_CONFIG_DESC];
extern const uint8_t CompositeVCPMassDevice_ConfigDescriptor[CDCMSC_SIZ_CONFIG_DESC];
